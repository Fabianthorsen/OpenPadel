...
<div
	bind:this={container}
	class="relative flex h-dvh flex-1 flex-col overflow-hidden"
	role="region"
...
>
	...
	<div
		class="min-h-0 flex-1 will-change-transform"
		style="transform: translateY({refreshing ? 64 : dragOffset}px); transition: {dragging
			? 'none'
			: `transform 0.45s ${springEase}`};"
	>
